...
* Integrated OpenAI API for personalized financial literacy storytelling and ElevenLabs for voice feedback
* Connected web interactions to Raspberry Pi and Arduino components to create a real-time “phygital” learning experience
* Collaborated on a working prototype combining web development, AI APIs, educational design, and robotics
...
* Implemented local mapping using ultrasonic distance readings to generate an occupancy grid and point overlay
* Designed Wi-Fi scanning logic to estimate possible nearby human activity using RSSI and device activity scoring
* Added safety and resource-management logic, including obstacle-based motion blocking and PWM ownership control
* Documented setup, testing commands, troubleshooting steps, and Raspberry Pi OS deployment instructions

#### 🔗 Links

* Devpost: [Project Page](https://devpost.com/software/pi-scout)
...
* Built explicit Sensor → Computation → Actuator pipelines using LF reactors, logical timers, and structured data flow
* Benchmarked correctness, timing behavior, CPU usage, deadline handling, and runtime performance across implementations
* Analyzed generated C code, scheduler behavior, dependency graphs, and execution order to understand runtime-level determinism
* Documented implementation steps, benchmark workflow, technical findings, and reproducible experiment notes
...
* Used ultrasonic sensing and buzzer-based feedback to alert users of nearby obstacles
* Designed the system to support safer navigation and spatial awareness for visually impaired users
* Collaborated on a hackathon prototype from concept to demo under time constraints

#### 🔗 Links

* Devpost: [Project Page](https://devpost.com/software/aaj)
* Demo: [Watch Demo](https://www.youtube.com/watch?v=th8GB3eLFiM)
* GitHub: [Repository](https://github.com/demardefrozen10/SENSE)

---

### 🥁 Beats By Air — QNX RTOS Air Drums
...
* Helped communicate the system’s real-time constraints, scheduling approach, and gesture detection workflow
* Supported demo preparation, technical documentation, and sponsor-facing presentation
* Documented the project architecture and lessons learned as a technical case study
...
* Used ultrasonic sensing for opponent detection, positioning, and attack behavior
* Tuned control logic to improve reaction timing, movement decisions, and match performance
* Debugged sensor readings, motor behavior, wiring issues, and competition reliability

#### 🔗 Links

* Demo: [Watch competition demo — my bot is on the left](https://www.youtube.com/watch?v=j7H8w4HQo3c)
...
* Applied k-means clustering and linear regression for exploratory analysis and prediction
* Developed an automated plant watering system using a MOSFET relay, water pump, and sensor-based control logic

#### 🔗 Links

* GitHub: [Repository](https://github.com/aruzhan-zhan/environmental-monitoring-and-automation)
* Real-Time Environmental Monitoring Demo: [Watch Demo](https://www.youtube.com/watch?v=el4Gd9wrhBw)
* Automated Plant Watering Demo: [Watch Demo](https://www.youtube.com/watch?v=zWMFbRdRFU0)
